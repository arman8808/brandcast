...
const page = () => {
  return (
    <div className="mt-[7rem] xs:mt-[4rem] sm:mt-[7rem] w-[90%] relative flex items-center justify-center h-[500px]">
      ...
      <div
        className="bg-white absolute w-[80%] xs:w-[90%] rounded-md bottom-[-8rem] xs:bottom-[-2.5rem] sm:bottom-[-7rem] md:bottom-[-7.5rem] lg:bottom-[-11rem] xs:py-4 sm:py-3 md:py-1 lg:py-0"
